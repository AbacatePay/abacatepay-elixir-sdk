defmodule AbacatePay.Api.PublicMRR do
  ...
  """
  @spec get_mrr() :: {:ok, map()} | {:error, AbacatePay.ApiError.t()}
  def get_mrr do
    AbacatePay.HTTPClient.get("/public-mrr/mrr")
  end
  ...
  """
  @spec get_merchant_info() :: {:ok, map()} | {:error, AbacatePay.ApiError.t()}
  def get_merchant_info do
    AbacatePay.HTTPClient.get("/public-mrr/merchant-info")
  end
  ...
  """
  @spec get_revenue(String.t(), String.t()) :: {:ok, map()} | {:error, AbacatePay.ApiError.t()}
  def get_revenue(start_date, end_date) do
    AbacatePay.HTTPClient.get("/public-mrr/revenue/?startDate=#{start_date}&endDate=#{end_date}")
  end
end
